...
set_property IOSTANDARD LVCMOS33 [get_ports {tube_seg[7]}]
set_property IOSTANDARD LVCMOS33 [get_ports {tube_seg[6]}]
set_property IOSTANDARD LVCMOS33 [get_ports {tube_seg[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {tube_seg[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {tube_seg[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {tube_seg[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {tube_seg[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {tube_seg[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports clk]
set_property IOSTANDARD LVCMOS33 [get_ports rst]
set_property IOSTANDARD LVCMOS33 [get_ports uart_trigger]
set_property IOSTANDARD LVCMOS33 [get_ports upg_rx_i]
set_property IOSTANDARD LVCMOS33 [get_ports upg_tx_o]
set_property IOSTANDARD LVCMOS33 [get_ports work_trigger]

set_property PACKAGE_PIN Y18 [get_ports clk]
set_property PACKAGE_PIN N4 [get_ports rst]

set_property PACKAGE_PIN P20 [get_ports uart_trigger]
